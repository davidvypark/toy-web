      ...
      <div className="text-center max-w-md">
        ...
        <div className="mt-10 flex flex-col gap-4">
          <a
            ...
            className="flex items-center justify-center gap-3 px-6 py-3 bg-toy-text text-toy-background rounded-2xl font-medium hover:opacity-80 transition-opacity"
          >
          ...
          <a
            ...
            className="flex items-center justify-center gap-3 px-6 py-3 border border-toy-text text-toy-text rounded-2xl font-medium hover:bg-toy-text hover:text-toy-background transition-colors"
          >
