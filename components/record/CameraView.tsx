...
export function CameraView({ onRecorded, onBack }: CameraViewProps) {
  ...
  if (permissionDenied) {
    return (
      <div className="fixed inset-0 bg-black flex flex-col items-center justify-center px-6 text-center select-none">
  ...
  return (
    <div className="fixed inset-0 bg-black flex flex-col items-center justify-center px-4 py-4 select-none">
